...
const IndividualDonorDashboard = () => {
  ...
  const loadIndividualDonor = async () => {
    try {
      const donor = await getMyIndividualDonor();
      setIndividualDonor(donor);
    } catch (err) {
      // IMPORTANT: ignore error, donor may not exist yet
      console.warn("No individual donor profile found");
    }
  };
          ...
          <div className="bg-white rounded-xl shadow p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div>
                ...
                <span className="inline-block px-3 py-1 rounded text-sm bg-green-100 text-green-700">
      ...
      <div className="bg-white shadow">
        <div className="max-w-6xl mx-auto px-6 py-6">
          ...
          <p className="text-gray-600">
            Browse verified requests and contribute directly
          </p>
        </div>
      </div>
...
export default IndividualDonorDashboard;
